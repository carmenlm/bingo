...
function pintarCarton(numero) {

	var cadenaHtml = '<table id="carton' + numero + '">' + '<tr>' + '<th>B</th>' + '<th>I</th>' + '<th>N</th>' + '<th>G</th>' + '<th>O</th>' + '</tr>' + '<tr>' + '<td class="celda0"></td>' + '<td class="celda5"></td>' + '<td class="celda10"></td>' + '<td class="celda14"></td>' + '<td class="celda19"></td>' + '</tr>' + '<tr>' + '<td class="celda1"></td>' + '<td class="celda6"></td>' + '<td class="celda11"></td>' + '<td class="celda15"></td>' + '<td class="celda20"></td>' + '</tr>' + '<tr>' + '<td class="celda2"></td>' + '<td class="celda7"></td>	' + '<td class="libre">LIBRE</td>	' + '<td class="celda16"></td>	' + '<td class="celda21"></td>' + '</tr>' + '<tr>' + '<td class="celda3"></td>	' + '<td class="celda8"></td>	' + '<td class="celda12"></td>	' + '<td class="celda17"></td>	' + '<td class="celda22"></td>	' + '</tr>	' + '<tr>	' + '<td class="celda4"></td>' + '<td class="celda9"></td>	' + '<td class="celda13"></td>	' + '<td class="celda18"></td>	' + '<td class="celda23"></td>	' + '</tr>	' + '</table>';

	var div = document.getElementById('pintar');
